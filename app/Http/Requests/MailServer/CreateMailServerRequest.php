...
final class CreateMailServerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'provider' => ['required', 'string', 'in:'.implode(',', array_column(MailProvider::cases(), 'value'))],
            'protocol' => ['required', 'string', 'in:'.implode(',', array_column(MailProtocol::cases(), 'value'))],
