...
| `outbound:reconcile-usage` | every 15 minutes | Dry-run only (no `--confirm`); reports usage-reservation drift for operator review without mutating anything — see `docs/OUTBOUND_USAGE_ACCOUNTING.md` |
